...
# This script will execute rt-app with the given configuration
# collect tracing events generated by msr registers and
# collect execution times by difference, monitoring swapper process
