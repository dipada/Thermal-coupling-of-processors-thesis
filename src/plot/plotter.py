...
# This program plots the data from the csv files generated by the preprocessing.py script
# It can plot in two modes:
#   - Single plot: when the user specifies -s option and pass a directory that contains subdirectories for each cpu
#   - Multi plot: when the user pass directories that contains subdirectories with different frenquencies 
#     and each of these contains subdirectories for each cpu
#
# For complete usage see the help message running python plotter.py -h
...
def plot_grid_sublots(fig_name, ignore_empty=True, running_freq=None, conf_name=None, reads_range=None):
    ...
    if running_freq is not None or conf_name is not None or reads_range is not None:
        ...
        if conf_name is not None:
            param_txt += f"rt-app configuration: {conf_name}\n"
